    ...
    Column(
        ...
        Row (
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.temperature, currentConditions.conditions.temperature.toInt()),
                    style = TextStyle(
                ...
                Text(
                    text = stringResource(R.string.feels_like_temp,currentConditions.conditions.feelsLike.toInt()),
                    style = TextStyle(
                        fontSize = 12.sp
                    )
                )
        ...
        Column(
            ...
            Text(text = stringResource(R.string.low_temp, currentConditions.conditions.minTemperature.toInt()), style = textStyle)
            Text(text = stringResource(R.string.high_temp,currentConditions.conditions.maxTemperature.toInt()), style = textStyle)
            Text(text = stringResource(R.string.humidity,currentConditions.conditions.humidity.toInt()), style = textStyle)
            Text(text = stringResource(R.string.pressure,currentConditions.conditions.pressure.toInt()), style = textStyle)
        }
